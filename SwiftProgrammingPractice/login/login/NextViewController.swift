...
class NextViewController: UIViewController {
  ...
  private func print1Style() {
    ...
    print1.clipsToBounds = true
    print1.layer.cornerRadius = 10
  ...
  private func print2Style() {
    ...
    print2.clipsToBounds = true
    print2.layer.cornerRadius = 10
  ...
  @objc private func printBtnAction(_ sender: UIButton) {
    let alert = UIAlertController(title: "알림", message: "결제 금액은 \(total)원입니다.", preferredStyle: .alert)
    
    let cancelAction = UIAlertAction(title: "취소", style: .cancel, handler: nil)
    let getAction = UIAlertAction(title: "결제", style: .destructive) { _ in
      let alert2 = UIAlertController(title: "알림", message: "결제가 완료되었습니다.", preferredStyle: .alert)
      let alert2Action = UIAlertAction(title: "확인", style: .cancel, handler: nil)
