...
let numbers = [-2, -1, 0, 1, 2]
let numbers2 = numbers.filter { $0 >= 0 }
numbers2
...
let arr2 = array.map { $0.compactMap { $0 } }
let arr3 = array.flatMap { $0 }
let arr4 = array.flatMap { $0.compactMap { $0 } }
print(arr2)
print(arr3)
print(arr4)
...
let arr5 = mixedString.compactMap { Int($0) }.map { $0 * $0 }
print("arr5", arr5)
